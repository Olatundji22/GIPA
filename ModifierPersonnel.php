...
if (isset($_GET["Matri"]))
{
	$requette = "SELECT * FROM personnel WHERE Matricule= '".$_GET["Matri"]."'";
		...
		<div class="container">
			<div class="col-md-5">
				...
				<?php $row1 = mysqli_fetch_array($resulta) ; ?>
					<form role="form" action="Personnel.php" method="POST">
						<br style="clear:both">
						<h3 style="margin-bottom: 25px; text-align: center;">Modifier un Personnel</h3>
						<div class="form-group">
							<input type="text" class="form-control" id="Mat" name="Mat" placeholder="Matricule" value="<?php echo $row1["Matricule"]; ?>" required>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" id="nom" name="nom" placeholder="Nom" value="<?php echo $row1["NomPerso"]; ?>" required>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" id="prenom" name="prenom" placeholder="Prénom" value="<?php echo $row1["PrenPerso"]; ?>" required>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" id="mobile" name="mobile" placeholder="Tel" value="<?php echo $row1["TelPerso"]; ?>" required>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" id="adresse" name="adresse" placeholder="Adresse" value="<?php echo $row1["AdressPerso"]; ?>" required>
						</div>
						<div class="form-group">
							<input type="hidden" class="form-control" id="Matri" name="Matri"  value="<?php echo $_GET["Matri"] ?>" required>
						</div>
						<select class="form-control" name="Service">
							<option value="<?php echo $row1["CodeService"]; ?>"><?php echo $row1["CodeService"]; ?></option>
