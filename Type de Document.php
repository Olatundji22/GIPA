...
$reqtype = "SELECT * FROM type_document";
$resultat = mysqli_query($connect, $reqtype);

if (isset($_POST["Modifier"]))
{
	$requete = "UPDATE type_document SET CodeTypeDoc= '".$_POST["CodeType"]."' , LibelTypeDoc= '".$_POST["LibelType"]."'  WHERE CodeTypeDoc= '".$_POST["CodeT"]."' ";
   ...
   <body class="ola">
		...
		<div class="container">
			<div class="btn-toolbar">
				<a href="Formulaire Type de document.php"><button class="btn btn-primary">Nouveau</button></a>
			</div><br>
			<div class="well">
				<table class="table">
					<thead>
						<tr>
							<th>Code du Type de Document</th>
					...
					<tbody>
						...
						<tr>
							<td><?php echo $row1["CodeTypeDoc"]; ?></td>
							<td><?php echo $row1[1]; ?></td>
							<td><a href="ModifierType.php?CodeT=<?= $row1["CodeTypeDoc"]?>"><button type="button" class="btn btn-warning">Modifier</button></a>
							<a href="Supprimer.php?Type=<?= $row1["CodeTypeDoc"]?>"><button type="button" class="btn btn-danger">Supprimer</button></a></td>
						</tr>
						<?php endwhile; ?>
