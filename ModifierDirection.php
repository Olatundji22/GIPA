...
if (isset($_GET["CodeDire"]))
{
	$requette = "SELECT * FROM direction WHERE CodeDirection= '".$_GET["CodeDire"]."'";
		...
		<div class="container">
			<div class="col-md-5">
				...
				<?php $row1 = mysqli_fetch_array($resulta) ; ?>
					<form role="form" action="Direction.php" method="POST">
						<br style="clear:both">
						<h3 style="margin-bottom: 25px; text-align: center;">Modifier une Direction</h3>
						<div class="form-group">
							<input type="text" class="form-control" id="CodeDir" name="CodeDir" placeholder="Code de la Direction" value="<?php echo $row1["CodeDirection"]; ?>" required>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" id="LibelDir" name="LibelDir" placeholder="Nom de la Direction" value="<?php echo $row1["LibelDirection"]; ?>" required>
						</div>
						<div class="form-group">
							<input type="hidden" class="form-control" id="CodeD" name="CodeD"  value="<?php echo $_GET["CodeDire"] ?>" required>
						</div>
